...
type data = Record<"value" | "slug", string>;
...
export function FancyMultiSelect(
  ...
  const [selected, setSelected] = React.useState<data[]>([values[4]]);

  const handleUnselect = React.useCallback((val: data) => {
